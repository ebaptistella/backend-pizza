...
create sequence gen_pedidoitemadicional start with 1 increment by 1;
...
alter table tb_pedidoitemadicional add constraint pedidoitemadicional_pedidoitem_fk foreign key (cd_pedidoitem) references tb_pedidoitem(id);
alter table tb_pedidoitemadicional add constraint pedidoitemadicional_pizzaadicional_fk foreign key (cd_pizzaadicional) references tb_pizzaadicional(id);
